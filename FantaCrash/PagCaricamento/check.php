...
<head>
    ...
    <link rel="icon" href="/FantaCrash/PagCommon/img/Loghi/Nanoso_Limited.png">
</head>
...
function redirect()
        {
            setTimeout(function () {
                window.location.replace('http://gdp.kozow.com/FantaCrash/PagCommon');
                //window.location.replace('http://127.0.0.1/FantaCrash/PagCommon');
            }, 3000);
        }
