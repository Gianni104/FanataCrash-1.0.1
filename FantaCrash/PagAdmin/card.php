...
<head>
    ...
    <link rel="icon" href="../PagCommon/img/Loghi/Nanoso_Limited.png">
</head>
                ...
                <div class="row mx-5">
                    <div class="col d-flex">
                        <div style="padding-bottom:56.25%; position:relative; display:block; width: 100%">
                            <iframe width="100%" height="100%" src="../Cards/CardAdmin.php" frameborder="0" allowfullscreen="" style="position:absolute; top:0; left: 0"></iframe>
                        </div>
                        <div style="padding-bottom:56.25%; position:relative; display:block; width: 100%">
                            <iframe width="100%" height="100%" src="../Cards/Card.php" frameborder="0" allowfullscreen="" style="position:absolute; top:0; left: 0"></iframe>
                        </div>
                    </div>
